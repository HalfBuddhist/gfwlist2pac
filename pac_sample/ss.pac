var FindProxyForURL = function(init, profiles) {
    ...
    "+AutoSS": function(url, host, scheme) {
        "use strict";
        // wildcard
        ...
        if (/(?:^|\.)gitbooks\.io$/.test(host)) return "+SS";
        if (/(?:^|\.)elastic\.co$/.test(host)) return "+SS";
        if (/(?:^|\.)draw\.io$/.test(host)) return "+SS";
        if (/(?:^|\.)docker\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)epochtimes\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)yasiv\.com$/.test(host)) return "+SS";
        ...
        if (/(?:^|\.)sexvon\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)lpl\.qq\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)zerotier\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)medium\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)pinb888\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)freshchat\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)pinbet88\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)apache\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)jetbrains\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)manjaro\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)bt\.byr\.cn$/.test(host)) return "+SS";
        if (/(?:^|\.)privoxy\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)sourceforge\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)kcjisu\.fun$/.test(host)) return "+SS";

		//porn
		if (/(?:^|\.)sexvon\.com$/.test(host)) return "+SS";
		if (/(?:^|\.)av6k\.com$/.test(host)) return "+SS";


		//google
        if (/(?:^|\.)googleusercontent\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)google\.com\.sg$/.test(host)) return "+SS";
        if (/(?:^|\.)google\.co\.jp$/.test(host)) return "+SS";
        if (/(?:^|\.)google\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)gmail\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)imap\.gmail\.com$/.test(host)) return "+SS";
        ...
        if (/(?:^|\.)content\.googleapis\.com$/.test(host)) return "+SS";
		...
		if (/(?:^|\.)crunchbase\.com$/.test(host)) return "+SS";
		if (/(?:^|\.)bizjournals\.com$/.test(host)) return "+SS";
        ...
        if (/(?:^|\.)youtube/.test(host)) return "+SS";
        if (/(?:^|\.)youtube\.be/.test(host)) return "+SS";
        if (/(?:^|\.)google\.cn/.test(host)) return "+SS";
        ...
        if (/(?:^|\.)tfbnw\.com$/.test(host)) return "+SS";
        ...
        if (/(?:^|\.)posterous\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)tinypic\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)twitpic\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)bitly\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)yfrog\.com$/.test(host)) return "+SS";

		// autoss list
		if (/(?:^|\.)1001yx\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)1024mx\.bid$/.test(host)) return "+SS";
        if (/(?:^|\.)1684\.cc$/.test(host)) return "+SS";
        if (/(?:^|\.)17kanb\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)188bet\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)2341\.tv$/.test(host)) return "+SS";
        if (/(?:^|\.)5dimes\.eu$/.test(host)) return "+SS";
        if (/(?:^|\.)6-seconds\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)608088\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)654k\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)917rbb\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)917rbb\.pw$/.test(host)) return "+SS";
        if (/(?:^|\.)925fxw\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)about\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)apple\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)appwen\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)asiancapper\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)bbc\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)betandskill\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)bitsnoop\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)bo1\.me$/.test(host)) return "+SS";
        if (/(?:^|\.)btku\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)businessweekly\.com\.tw$/.test(host)) return "+SS";
        if (/(?:^|\.)cc5\.cc$/.test(host)) return "+SS";
        if (/(?:^|\.)checkio\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)chinadmd\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)chinanetwifi\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)cjzxedu\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)cloudfront\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)cn163\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)cnproxy\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)crazyfeng\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)cyrusin\.github\.io$/.test(host)) return "+SS";
        if (/(?:^|\.)d309xhyv4asw4n\.cloudfront\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)dianliwenmi\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)digitalocean\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)duanzhihu\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)e7wan\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)ebookabc\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)fenxs\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)free-lunwen\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)freebets\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)github\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)githubapp\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)goldencui\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)google\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)greplin\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)hackerrank\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)hd62\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)hdwan\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)linuxsir\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)livefootballol\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)livefootballol\.me$/.test(host)) return "+SS";
        if (/(?:^|\.)loeyun\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)loldytt\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)loopc\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)lynu\.edu\.cn$/.test(host)) return "+SS";
        if (/(?:^|\.)memect\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)mergely\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)no-ip\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)noalgo\.info$/.test(host)) return "+SS";
        if (/(?:^|\.)owenyang0\.github\.io$/.test(host)) return "+SS";
        if (/(?:^|\.)pcmag\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)pocoo\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)researchgate\.net$/.test(host)) return "+SS";
        if (/(?:^|\.)rus\.ec$/.test(host)) return "+SS";
        if (/(?:^|\.)sbobet\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)scgsj\.gov\.cn$/.test(host)) return "+SS";
        if (/(?:^|\.)sci-hub\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)sshgfw\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)tensorflow\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)tokyocold\.cn$/.test(host)) return "+SS";
        if (/(?:^|\.)tom365\.co$/.test(host)) return "+SS";
        if (/(?:^|\.)topcoder\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)ubuntips\.com\.ar$/.test(host)) return "+SS";
        if (/(?:^|\.)v2ex\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)valleytalk\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)voicetube\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)vziyuan\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)wikia\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)wikipedia\.org$/.test(host)) return "+SS";
        if (/(?:^|\.)wordpress\.com$/.test(host)) return "+SS";
        if (/(?:^|\.)wuji8\.com$/.test(host)) return "+SS";
    ...
    "+SS": function(url, host, scheme) {
        ...
        return "SOCKS5 127.0.0.1:8387; SOCKS 127.0.0.1:8387; DIRECT;";
    },
    "+__ruleListOf_AutoSS": function(url, host, scheme) {
        "use strict";
